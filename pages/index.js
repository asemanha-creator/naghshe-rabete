    ...
    10: {
      ...
      levels: {
        ...
        advanced: [
          ...
          { type: "p", text: "این نسخه، مستقل از سطحِ «عالی»، ۵ تمرینِ کاملاً متفاوت و پیچیده‌تر ارائه می‌دهد — برایِ کسانی که ظرفیتِ روانیِ لازم برایِ کارِ تحلیلی و عمیقِ فشرده‌تر را دارند. این تمرین‌ها از ابزارهایِ کمّی، رواندرمانیِ اجزاء (Parts Work)، و تحلیلِ سناریو استفاده می‌کنند." },

          { type: "h", text: "تمرینِ ۱ — ماتریسِ تصمیمِ چندمعیاره" },
          { type: "technique", name: "ماتریسِ وزن‌دارِ تصمیم", time: "۴۵ دقیقه", howTo: "۷ معیار بنویسید که برایتان مهم است (مثلاً: امنیتِ مالی، رفاهِ فرزندان، امنیتِ هیجانی، پتانسیلِ صمیمیتِ جنسی، رشدِ فردی، حمایتِ اجتماعی، سلامتِ جسمی). به هر معیار، وزنِ اهمیت از ۱ تا ۱۰ بدهید. سپس هرکدام از دو گزینه (ماندن/رفتن) را از ۱ تا ۱۰ برایِ هر معیار نمره بدهید. نمره‌ی هر گزینه در هر معیار را در وزنش ضرب کنید و جمع بزنید.", effect: "برخلافِ لیستِ ساده‌ی خوب‌وبد، این روش به معیارهایِ مهم‌تر وزنِ بیشتری می‌دهد — یعنی یک موردِ کوچک نمی‌تواند به‌اندازه‌ی یک موردِ حیاتی در تصمیم اثر بگذارد.", more: "این روش نسخه‌ی ساده‌شده‌ی Multi-Criteria Decision Analysis (MCDA) است که در تصمیم‌گیری‌هایِ پیچیده‌ی سازمانی و پزشکی استفاده می‌شود. تفاوتِ کلیدی‌اش با کاربرگِ ساده این است که فرضِ «همه‌ی عوامل به‌یک‌اندازه مهم‌اند» را کنار می‌گذارد — که معمولاً در تصمیم‌هایِ احساسی، نادرست است." },

          { type: "h", text: "تمرینِ ۲ — گفت‌وگویِ اجزایِ درونی (Parts Work)" },
          { type: "technique", name: "دیالوگِ چهاربخشیِ خود", time: "۳۰ دقیقه", howTo: "چهار «بخش» از خودتان را روی چهار برگه جدا بنویسید: «بخشِ ترسیده» (چه می‌گوید؟)، «بخشِ خشمگین»، «بخشِ امیدوار»، «بخشِ خسته». برایِ هرکدام، یک پاراگراف از زبانِ خودش بنویسید که چرا او می‌خواهد بمانید یا بروید. در پایان، یک برگه‌ی پنجم بنویسید: «خودِ خردمند، بعد از شنیدنِ هر چهار صدا، چه می‌گوید؟»", effect: "تصمیم‌هایِ پس‌ازخیانت معمولاً حاصلِ جنگِ داخلیِ چند بخشِ متضاد از خودتان‌اند؛ این تمرین، به‌جایِ سرکوبِ یکی به‌نفعِ دیگری، به هرکدام فرصتِ شنیده‌شدن می‌دهد.", more: "این تکنیک برگرفته از مدلِ Internal Family Systems (IFS) است. در IFS، «خودِ خردمند» (Self) بخشی است که آرام، کنجکاو، و دلسوز است و توانِ گوش‌دادن به همه‌ی بخش‌هایِ متضاد را دارد بدونِ این‌که با هیچ‌کدام یکی شود. تمرینِ منظم، دسترسی به این «خود» را تقویت می‌کند." },

          { type: "h", text: "تمرینِ ۳ — تحلیلِ حساسیتِ سناریو" },
          { type: "technique", name: "سه‌سناریویِ هر گزینه", time: "۴۰ دقیقه", howTo: "برایِ «ماندن»، سه سناریو بنویسید: بدترین‌حالتِ واقع‌بینانه، محتمل‌ترین‌حالت، بهترین‌حالتِ واقع‌بینانه (نه فانتزی). همین سه سناریو را برایِ «رفتن» هم بنویسید (۶ سناریوی کل). برایِ هر سناریو، از ۱ تا ۱۰ بنویسید «اگر این اتفاق بیفتد، چقدر می‌توانم با آن کنار بیایم؟»", effect: "این تمرین ترسِ مبهم از «بدترین حالت» را به یک تصویرِ مشخص و قابلِ‌ارزیابی تبدیل می‌کند — اغلب معلوم می‌شود بدترین‌حالتِ واقع‌بینانه، آن‌قدرها که تصور می‌کردیم غیرِقابلِ‌تحمل نیست.", more: "این روش از تحلیلِ حساسیت در تصمیم‌گیریِ تحتِ عدمِ قطعیت الهام گرفته. نکته‌ی کلیدی، تمرکز بر «واقع‌بینانه» است، نه فاجعه‌سازیِ افراطی یا خوش‌بینیِ غیرِواقعی — هر دو انحراف، تصمیم را مخدوش می‌کنند." },

          { type: "h", text: "تمرینِ ۴ — بررسیِ بدنی (Somatic Decision Check)" },
          { type: "technique", name: "چکِ بدنیِ دو‌گزینه‌ای", time: "۱۰ دقیقه", howTo: "در سکوت بنشینید. برایِ ۲ دقیقه، کاملاً تصور کنید که «ماندن» را قطعی انتخاب کرده‌اید — نه فکر کنید، فقط این تصمیم را در بدنتان حس کنید. به قفسه‌ی سینه، شکم، و تنفستان توجه کنید: باز است یا منقبض؟ سبک است یا سنگین؟ همین کار را برایِ «رفتن» هم با ۲ دقیقه‌ی جدا تکرار کنید.", effect: "بدن اغلب اطلاعاتی دارد که ذهنِ تحلیل‌گر هنوز به آن نرسیده — این تمرین آن سیگنال را در کنارِ تحلیلِ عقلانی (نه به‌جایِ آن) قرار می‌دهد.", more: "این رویکرد از نظریه‌ی پلی‌واگال (Polyvagal Theory) و «حسِ درونی» (Interoception) در تصمیم‌گیری الهام گرفته. پژوهش‌های علوم اعصاب نشان می‌دهند بدن اغلب چند ثانیه زودتر از آگاهیِ آگاهانه، واکنشِ فیزیولوژیک به گزینه‌هایِ مختلف نشان می‌دهد." },

          { type: "h", text: "تمرینِ ۵ — نامه‌هایِ دوسوگرا از آینده" },
          { type: "technique", name: "دو نامه از آینده‌ی موفق", time: "۳۰-۴۵ دقیقه", howTo: "دو نامه‌ی کاملاً جداگانه بنویسید: یکی خطاب به خودتان، از زبانِ آینده‌ای که «ماندن» را انتخاب کرده و به آن افتخار می‌کند (چرا درست بود، چه گذشت)؛ دیگری از آینده‌ای که «رفتن» را انتخاب کرده و به آن افتخار می‌کند. هر دو را با جزئیاتِ احساسیِ کامل بنویسید — نه خلاصه.", effect: "چون هر دو سناریو از منظرِ یک آینده‌ی «موفق» نوشته می‌شوند (نه ترس‌آلود)، تصویرِ واضح‌تر و کمتر جانب‌دارانه‌ای از هرکدام به‌دست می‌آید.", more: "این تکنیک از رواندرمانیِ روایتی (Narrative Therapy) الهام گرفته. نوشتنِ هر دو سناریو به‌شکلِ مثبت، تعصبِ منفی‌نگریِ رایج در تصمیم‌گیریِ پسِ‌ترومایی را خنثی می‌کند." },

          { type: "checklist", items: [
            "ماتریسِ وزن‌دارِ تصمیم را کامل کردم.",
            "دیالوگِ چهاربخشی را نوشتم و صدایِ «خودِ خردمند» را شنیدم.",
            "شش سناریو (۳+۳) را نوشتم و توانِ کنارآمدن با هرکدام را نمره دادم.",
            "چکِ بدنیِ دو‌گزینه‌ای را انجام دادم.",
            "هر دو نامه‌ی آینده‌ی موفق را نوشتم.",
          ] },
          { type: "h", text: "اگر پیشرفت نکردید" },
          { type: "p", text: "این سطح فشرده و شناختاً سنگین است. اگر در میانه‌ی راه احساسِ فرسودگی یا سردرگمیِ بیشتر کردید، این نشانه‌ی ضعف نیست — فقط به این معناست که امروز، سطحِ «عالی» یا «ساده» انتخابِ بهتری است. می‌توانید هر زمان برگردید." },
          { type: "h", text: "🏠 رفتار با همسر" },
          { type: "p", text: "این تمرین‌ها عمدتاً فردی‌اند. اگر مایل بودید، فقط نتیجه‌ی کلی («خودِ خردمندم می‌گوید...») را با همسرتان در میان بگذارید، نه لزوماً جزئیاتِ هر بخش." },
        ],
      },
      callouts: [
        ...
        {screen === "start" && (
          <Card style={{ padding: 0, overflow: "hidden" }}>
            ...
            <p style={{ fontSize: 9.5, color: "#D3DEE4", marginTop: 14, textAlign: "center" }}>
              نسخه: ۲۰۲۶-۰۹-۰۷ / سطحِ پیشرفته کاملاً مستقل و متفاوت شد (۵ تکنیکِ جدید، نه تکرارِ عالی)
            </p>
            </div>
          </Card>
        )}
