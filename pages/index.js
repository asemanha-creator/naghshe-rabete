  ...
  betrayed: {
    1: {
      ...
      body: [
        ...
        { type: "h", text: "تکنیکِ کاربردیِ ۳: تنفسِ ۴-۷-۸ برایِ آرام‌سازیِ فوری" },
        { type: "p", text: "۴ ثانیه از بینی نفس بکشید، ۷ ثانیه نگه دارید، ۸ ثانیه از دهان به‌آرامی بازدَم کنید. این الگو مستقیماً سیستمِ عصبیِ پاراسمپاتیک (ترمزِ طبیعیِ بدن) را فعال می‌کند و ظرفِ کمتر از دو دقیقه، ضربانِ قلب را پایین می‌آورد. سه دور کافی است. این تکنیک را می‌توانید حتی وسطِ روز، در ماشین، یا در دستشویی محلِ کار انجام دهید — کسی متوجه نمی‌شود." },
