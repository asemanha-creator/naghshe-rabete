...
const SESSION_CONTENT = {
  moderate: {
    ...
    6: { title: "سناریوهایِ فرضی — تمرینِ پاسخ به وسوسه‌هایِ محتمل", approach: "پیشگیریِ رفتاری", audioUrl: null, videoUrl: null, body: [{ type: "p", text: "متنِ کاملِ این جلسه به‌زودی تکمیل می‌شود." }] },
    7: { title: "صمیمیتِ هیجانیِ روزانه", approach: "EFT", audioUrl: null, videoUrl: null, body: [{ type: "p", text: "متنِ کاملِ این جلسه به‌زودی تکمیل می‌شود." }] },
    8: { title: "صمیمیتِ جنسیِ محافظ", approach: "گاتمن", audioUrl: null, videoUrl: null, body: [{ type: "p", text: "متنِ کاملِ این جلسه به‌زودی تکمیل می‌شود." }] },
    9: { title: "قدردانیِ روزانه", approach: "مثبت‌نگر", audioUrl: null, videoUrl: null, body: [{ type: "p", text: "متنِ کاملِ این جلسه به‌زودی تکمیل می‌شود." }] },
    10: { title: "حلِ تعارض بدونِ انباشتِ کینه", approach: "گاتمن", audioUrl: null, videoUrl: null, body: [{ type: "p", text: "متنِ کاملِ این جلسه به‌زودی تکمیل می‌شود." }] },
    11: { title: "نقشه‌ی عشقِ به‌روزشونده", approach: "گاتمن", audioUrl: null, videoUrl: null, body: [{ type: "p", text: "متنِ کاملِ این جلسه به‌زودی تکمیل می‌شود." }] },
    12: { title: "مدیریتِ استرسِ بیرونی به‌عنوانِ تیم", approach: "سیستمی", audioUrl: null, videoUrl: null, body: [{ type: "p", text: "متنِ کاملِ این جلسه به‌زودی تکمیل می‌شود." }] },
    13: { title: "دوره‌ی پرخطر: تولدِ فرزند/تغییرِ شغل", approach: "پیشگیری", audioUrl: null, videoUrl: null, body: [{ type: "p", text: "متنِ کاملِ این جلسه به‌زودی تکمیل می‌شود." }] },
    14: { title: "دوره‌ی پرخطر: سفرِ کاری و دوریِ فیزیکی", approach: "پیشگیری", audioUrl: null, videoUrl: null, body: [{ type: "p", text: "متنِ کاملِ این جلسه به‌زودی تکمیل می‌شود." }] },
    15: { title: "مرزهایِ دیجیتال", approach: "پیشگیری", audioUrl: null, videoUrl: null, body: [{ type: "p", text: "متنِ کاملِ این جلسه به‌زودی تکمیل می‌شود." }] },
    16: { title: "مدیریتِ جذابیتِ بیرونی (وقتی، نه اگر)", approach: "پیشگیریِ رفتاری", audioUrl: null, videoUrl: null, body: [{ type: "p", text: "متنِ کاملِ این جلسه به‌زودی تکمیل می‌شود." }] },
    17: { title: "تشخیصِ زودهنگامِ فاصله‌گیریِ همسر", approach: "EFT", audioUrl: null, videoUrl: null, body: [{ type: "p", text: "متنِ کاملِ این جلسه به‌زودی تکمیل می‌شود." }] },
    18: { title: "بازیابی بعد از یک نزدیکیِ خطرناک (نه خیانتِ کامل)", approach: "پیشگیری", audioUrl: null, videoUrl: null, body: [{ type: "p", text: "متنِ کاملِ این جلسه به‌زودی تکمیل می‌شود." }] },
    19: { title: "بازبینیِ فصلیِ قرارداد", approach: "گاتمن", audioUrl: null, videoUrl: null, body: [{ type: "p", text: "متنِ کاملِ این جلسه به‌زودی تکمیل می‌شود." }] },
    20: { title: "برنامه‌ی نگهداری: تکرارِ پرسشنامه و ورود به چرخه‌ی مراقبتِ مستمر", approach: "نگهداریِ درازمدت", audioUrl: null, videoUrl: null, body: [{ type: "p", text: "متنِ کاملِ این جلسه به‌زودی تکمیل می‌شود." }] },
  },
  advanced: {
    1: {
        ...
        {screen === "start" && (
          <Card style={{ padding: 0, overflow: "hidden" }}>
            ...
            <p style={{ fontSize: 9.5, color: "#D3DEE4", marginTop: 14, textAlign: "center" }}>
              نسخه: ۲۰۲۶-۰۹-۱۱ / تکمیلِ جلساتِ ۲ تا ۵ِ پیشگیری با عمقِ کامل (دیوار-پنجره، قراردادِ مرزها، جلسه‌ی هفتگی، زبانِ نیاز)
            </p>
            </div>
          </Card>
        )}
